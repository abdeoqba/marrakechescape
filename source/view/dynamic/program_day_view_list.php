<?php
  ...
  $p = new ProgramDay();
  $p->getAllProgramDay($page_number);
...
?>
      ...
      <div class="container-fluid py-5">
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <h2>List of Program Day <span class="badge badge-primary badge-pill" style="font-size:11pt;"><?=count($p->program_days); ?></span></h2>
          </div>
          <div class="col-lg-6 col-md-6 text-right pb-3">
            ...
            <!-- truncate -->
            <button type="button" class="btn btn-danger d-none" onclick="program_day_truncate_set();" <?php 
            if(!$_SESSION[variables::$prefix."allow_truncate"]) echo "disabled";
            ?>>
              <i class="fa fa-trash-alt"></i> Truncate Program Day
            </button>
            
            <!-- trash link -->
            <?php 
            if($_SESSION[variables::$prefix."allow_trash"]){
              $p->getNbrDeletedProgramDay(); 
            ?>
            <a href="program_days-trash" class="btn btn-danger btn-fixed btn-<?=$nbr_btn; ?>">
            ...
            <button type="button" class="btn btn-primary btn-fixed btn-<?=$nbr_btn; ?>" data-toggle="modal" data-target="#ProgramDayAddModal">
    ...
    <?php if($_SESSION[variables::$prefix."allow_edit"]){ ?>
      ...
      <?php include(variables::$root."/source/view/modal/program_day_section_modal_form_add.php"); ?>
      <?php include(variables::$root."/source/view/modal/program_day_section_modal_form_update.php"); ?>
      <?php include(variables::$root."/source/view/modal/program_day_section_modal_confirm_move_to_trash.php"); ?>
      
      <?php if(($_SESSION[variables::$prefix."allow_truncate"])){ ?>
        <?php include(variables::$root."/source/view/modal/program_day_section_modal_confirm_truncate.php"); ?>
