        ...
        <div class="modal-dialog" role="document">
          <form class="modal-content" action="category-add" method="POST"  >
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="CategoryAddModalLabel">New Category</h5>
            ...
            <div class="modal-body <?php if($nbr_categorys==0) echo 'p-0'; ?>">
                <div class="card rounded-0 border-0 text-light bg-danger">
                  <div class="card-body">
                    ...
                    <p class="card-text">To add a Category there must be existing Categorys, But there are no Categorys now. To add a new pen go to the list of Categorys</p>
            ...
            <div class="modal-body <?php if($nbr_images==0) echo 'p-0'; ?>">
                <div class="card rounded-0 border-0 text-light bg-danger">
                  <div class="card-body">
                    <h5 class="card-title"></h5>
                    <h6 class="card-subtitle mb-2">Something is missing</h6>
                    <p class="card-text">To add a Category there must be existing Images, But there are no Images now. To add a new pen go to the list of Images</p>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary" <?php if($fk_missing) echo 'disabled'; ?>><i class="fa fa-plus"></i> Add Category</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <script>
      //add onclick="category_add_submit();"
      // function category_add_submit(){
      //   $("#CategoryAddModal form").submit();
      // }
      </script>
